    ...
    <div id='aboutme' className='w-screen'>
      ...
      <div className='px-12'>
        ...
        <div className='mb-7 flex justify-center items-center relative'>
          ...
          <hr className='-z-10 border-green/20 w-line absolute -rotate-aboutme-line' />
          <div className="gradient w-96 aspect-square absolute rounded-full"></div>
        ...
        <div className='flex flex-col gap-5'>
          <p className='text-sm font-thin'>
            <em className='text-black'>lorem</em> I'm Dilshan Rangaka, a versatile full-stack developer experienced in Java, JavaScript, and web development, with a strong emphasis on POS (Point of Sale) systems. I'm passionate about crafting innovative solutions and user-friendly experiences. My dedication to clean code and a user-centric approach sets me apart. Let's collaborate to turn your ideas into reality.
          </p>
        ...
        <div className='flex flex-wrap justify-center mt-5 gap-3 mb-10'>
          {
            technologies.map(tech => <img className='w-10' src={tech.image} alt={tech.image} />)
          }
        </div>
      </div>
    </div>
