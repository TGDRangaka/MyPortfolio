    ...
    <div id='home' className='w-screen min-h-svh flex flex-col overflow-hidden relative  lg:flex-row'>
      ...
      <div className='flex-grow flex flex-col justify-center relative px-5 lg:px-10  xl:flex-grow-0'>
        ...
        <div className='mt-2 flex h-8 gap-2  sm:h-10 lg:h-10 items-center lg:mb-28 lg:gap-5 lg:mt-6'>
          <button type='button' className='bg-green text-black rounded px-8 h-full  sm:px-10  lg:px-14  hover:scale-110 duration-150 hover:-rotate-6 hover:translate-y-2'>
